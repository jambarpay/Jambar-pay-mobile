...
import 'package:jambar_pay_mobile/design_system/tokens/app_elevation.dart';
      ...
      child: ConstrainedBox(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: AppElevation.authCard,
          ),
          child: child,
        ),
      ),
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  border: Border(
                    right: BorderSide(color: AppColors.lightDivider),
                  ),
                ),
                child: Row(
                  children: [
